...
import { RegStatus, TransactionsEntity } from './infrastructure/persistence/relational/entities/transactions.entity';
...
export class SubscriptionsService {
  constructor(private readonly subscriptionRepository: SubscriptionRepository,
              ...
              @InjectRepository(TransactionsEntity) private transactionRepository: Repository<TransactionsEntity>,
  ) {}
  ...
  update(id: Subscription['id'], updateSubscriptionDto: UpdateSubscriptionDto) {
